...
:film_projector: [Видеоруководство](https://youtube.com/watch?v=BqCOnQOvMY8) &#x3000;
:envelope_with_arrow: [В виде EXE](https://github.com/adslbarxatov/DPArray/releases/latest)

Инструмент развёртки продуктов Лаборатории. Инструмент выполняет установку, удаление, проверку обновлений, загрузку пакетов и их зависимостей.
...
:iphone: [На AppGallery](https://url.cloud.huawei.com/kOns67WJJ6) &#x3000;
...
веб-сайтов. Другими словами, об их обновлениях, которые будут представлены в виде текстового журнала.
...
:iphone: [На AppGallery](https://url.cloud.huawei.com/kOnu2dYlNu) &#x3000;
...
Адаптация движка [Xash3d FWGS](https://github.com/FWGS/xash3d-fwgs) для мода ESHQ для Half-Life 1
